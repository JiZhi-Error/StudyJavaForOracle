    ...
    static class BasicThree {
        public static void main(String[] args) {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                s.sort((o1, o2) -> {
                    Integer value = BasicTwo.getKey(map, o1);
                    Integer value1 = BasicTwo.getKey(map, o2);
        ...
        private static void sort(String[] strings, Map<Integer, String> map) {
            for (int i = 0; i < strings.length; i++) {
                for (int j = 0; j < strings.length; j++) {
                    ...
                    Integer one = BasicTwo.getKey(map, string);
                    Integer two = BasicTwo.getKey(map, string1);
                    if (one > two) {
